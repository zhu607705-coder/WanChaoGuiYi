...
namespace WanChaoGuiYi
{
    public sealed class WeatherPanel : MonoBehaviour
    {
        ...
        public void Bind(GameObject root, Text weatherName, Text weatherEffect, Text celestialEvent, Text resilience, Button close)
        {
            panelRoot = root;
            weatherNameText = weatherName;
            weatherEffectText = weatherEffect;
            celestialEventText = celestialEvent;
