...
Write-Host '  powershell -ExecutionPolicy Bypass -File tools\unity\run_playmode_tests.ps1 "My project"'
Write-Host '  or tools\unity\run_playmode_tests.cmd "My project"'
Write-Host ""
